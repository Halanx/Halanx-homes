...
from Houses.utils import (HouseTypeCategories, HouseFurnishTypeCategories, HouseAccomodationAllowedCategories,
                          ...
                          default_profile_pic_url, SHARED_ROOM, PRIVATE_ROOM)
...
class House(models.Model):
    ...
    address = models.ForeignKey('HouseAddressDetail', null=True, on_delete=models.SET_NULL, related_name='houses')
...
class HouseVisit(models.Model):
    ...
    customer = models.ForeignKey('Common.Customer', on_delete=models.SET_NULL, null=True, related_name='house_visits')
